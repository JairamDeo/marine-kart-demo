...
export default function CustomerAccount() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="portal-fade-in overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a4b8c] via-[#1e5a9e] to-[#0f172a] text-white shadow-lg">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="portal-fade-in rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-2xl font-bold text-navy">Customer</p>
        </div>
        <div className="portal-fade-in rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        >
          ...
          <button
            type="submit"
            disabled={busy}
            className="cursor-pointer rounded-xl bg-[#1a4b8c] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#143a6e] disabled:opacity-60"
          >
